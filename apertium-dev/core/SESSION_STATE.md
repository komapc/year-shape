...
### Created
- `/home/mark/projects/apertium-dev/TRANSLATION_ERROR_ANALYSIS.md` - Comprehensive error analysis
...
```bash
# Regenerate bidix
cd /home/mark/projects/apertium-dev/projects/extractor
python3 scripts/generate_bidix.py \
  --input data/merged_bidix.json \
  --output apertium-ido-epo.ido-epo.dix

# Rebuild apertium-ido-epo
cd /home/mark/projects/apertium-dev/apertium/apertium-ido-epo
cp /home/mark/projects/apertium-dev/projects/extractor/apertium-ido-epo.ido-epo.dix .
make clean && make -j4

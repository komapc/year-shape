...
def translate(text: str) -> str:
    """Run a string through the local Apertium pipeline manually."""
    apertium_dir = '/home/mark/projects/apertium-dev/apertium-ido-epo'
    
    # Run the full pipeline chain manually to avoid mode-file path issues
    cmd = (f'lt-proc {apertium_dir}/ido-epo.automorf.bin | '
           f'apertium-pretransfer -n | '
           f'lt-proc -b {apertium_dir}/ido-epo.autobil.bin | '
           f'apertium-transfer -b {apertium_dir}/apertium-ido-epo.ido-epo.t1x {apertium_dir}/ido-epo.t1x.bin | '
           f'lt-proc -g {apertium_dir}/ido-epo.autogen.bin | '
           f'lt-proc -p {apertium_dir}/ido-epo.autopgen.bin')
